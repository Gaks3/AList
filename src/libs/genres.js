...
// const genres = data.data.forEach((value, index) => {
//   let id = ''

//   if (index == data.data.length - 1) id = id + ', ' + value.mal_id
//   id = id + ', ' + value.mal_id
...
for (let i = 0; i < data.data.length; i++) {
  if (i == 0) genres = genres + data.data[i].mal_id
  genres = genres + ', ' + data.data[i].mal_id
}
